<template>
  <div>
    <el-row :gutter="20">
      ...
      <el-col :span="8">
        <div class="card dbsx">
          <p class="title"><i class="fa fa-file-text-o"></i>数据统计</p>
          <ul>
            <li><router-link to="#"><span>新增用户</span><span class="num">66</span></router-link></li>
            <li><router-link to="#"><span>新增订单</span><span class="num">66</span></router-link></li>
            <li><router-link to="#"><span>新增订单</span><span class="num">66</span></router-link></li>
          </ul>
          <ul>
            <li><router-link to="#"><span>注册用户</span><span class="num">66</span></router-link></li>
            <li><router-link to="#"><span>订单</span><span class="num">66</span></router-link></li>
            <li><router-link to="#"><span>管理员</span><span class="num">66</span></router-link></li>
          </ul>
        </div>
      </el-col>
      <el-col :span="8">
